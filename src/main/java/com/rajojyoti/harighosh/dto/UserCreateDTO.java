...
public class UserCreateDTO {
	...
	public UserCreateDTO(String userId, String name, String username, String password, String emailaddress,
			String phonenumber, String address, String bloodgroup, String timestamp, String updatedby) {
		super();
		this.userId = userId;
		this.name = name;
		this.username = username;
	...
	public String toString() {
		return "UserCreateDTO [userId=" + userId + ", name=" + name + ", username=" + username + ", password="
				+ password + ", emailaddress=" + emailaddress + ", phonenumber=" + phonenumber + ", address=" + address
				+ ", bloodgroup=" + bloodgroup + ", timestamp=" + timestamp + ", updatedby=" + updatedby + "]";
	}
